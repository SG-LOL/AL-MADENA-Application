...
class ContractorComplaintListScreen extends StatefulWidget {
  const ContractorComplaintListScreen({Key? key}) : super(key: key);

  @override
  _ContractorComplaintListScreenState createState() =>
      _ContractorComplaintListScreenState();
}

class _ContractorComplaintListScreenState
    extends State<ContractorComplaintListScreen> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  ContractorCompalintInfoScreen(complaintId: complaintId)),
        );
      },
      child: Container(
        width: cardWidth,
