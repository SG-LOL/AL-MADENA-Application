...
class MinistryComplaintListScreen extends StatefulWidget {
  const MinistryComplaintListScreen({Key? key}) : super(key: key);

  @override
  _MinistryComplaintListScreenState createState() =>
      _MinistryComplaintListScreenState();
}

class _MinistryComplaintListScreenState
    extends State<MinistryComplaintListScreen> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  MinistryCompalintInfoScreen(complaintId: complaintId)),
        );
      },
      child: Container(
        width: cardWidth,
