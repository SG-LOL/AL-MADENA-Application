...
import 'package:majed_s_application2/services/reviewer_services.dart';
...
class CreateReviewer extends StatelessWidget {
  CreateReviewer({
    Key? key,
  }) : super(key: key);
                    ...
                    child: Stack(alignment: Alignment.topRight, children: [
                      ...
                      Align(
                          ...
                          child: Padding(
                              ...
                              child: Text("Create Reviewer Account",
  ...
  Widget _buildPassword(BuildContext context) {
    return CustomTextFormField(controller: passwordController, readOnly: false);
  }

  Widget _buildConfirmPassword(BuildContext context) {
    return CustomTextFormField(
        controller: confirmpasswordController, readOnly: false);
  }
