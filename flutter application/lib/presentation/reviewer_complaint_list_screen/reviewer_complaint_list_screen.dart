...
class ReviewerComplaintListScreen extends StatefulWidget {
  const ReviewerComplaintListScreen({Key? key}) : super(key: key);

  @override
  _ReviewerComplaintListScreenState createState() =>
      _ReviewerComplaintListScreenState();
}

class _ReviewerComplaintListScreenState
    extends State<ReviewerComplaintListScreen> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  CompalintInfoReviewer(complaintId: complaintId)),
        );
      },
      child: Container(
        width: cardWidth,
